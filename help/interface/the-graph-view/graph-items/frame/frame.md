...
![Frames: Beschreibung](frame.resources/graph-frames_description.gif "Rahmen: Beschreibung"){width="640px"}
...
![Frames: Color](frame.resources/graph-frames_colour.gif "Rahmen: Farbe "){width="640px"}
