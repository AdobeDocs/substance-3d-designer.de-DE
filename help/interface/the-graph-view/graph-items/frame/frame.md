...
![Rahmen-Symbol](frame.resources/graphatomic-frame_1.png "Rahmen-Symbol")
...
![Rahmen (Standardstatus)](frame.resources/graph-frames-default.png "Rahmen (Standardstatus)")
...
![Rahmen (Hover-Zustand)](frame.resources/graph-frames-hover.png "Rahmen (Hover-Zustand)")
...
![Rahmen (ausgewählter Status)](frame.resources/graph-frames-selected.png "Rahmen (ausgewählter Status)")
...
![Frames: Erstellungsmethoden](frame.resources/graph-frames_creation.gif "Frames: Erstellungsmethoden"){width="480px"}
...
![Frames: Interaktionszonen](frame.resources/graph-frames_interaction-zones.png "Frames: Interaktionszonen")
...
![Frames: Rasterausrichtung](frame.resources/graph-frames_grid-snapping.gif "Frames: Rasterausrichtung ")
...
![Frames: Titel](frame.resources/graph_frames_title.gif "Bilder: Titel"){width="640px"}
...
Der Text kann mit HTML-Tags formatiert werden. Diese Formatierung wird durch Klicken auf die Schaltfläche ![](frame.resources/graph-frames_html-markup-button.png) <b>HTML-Markup</b> umgeschaltet.

Weitere Informationen finden Sie im Abschnitt &quot;Beschreibung&quot; weiter unten.

![Rahmen: Beschreibung](frame.resources/graph-frames_description.gif "Rahmen: Beschreibung"){width="640px"}
...
![Rahmen: Color](frame.resources/graph-frames_colour.gif "Rahmen: Farbe "){width="640px"}
...
Sein Format kann bei einer minimalen Bildschirmgröße gesperrt werden, sodass es beim Verkleinern des Grafen lesbar bleibt. Sie können dies tun, indem Sie die Option &quot;Rahmen titles&quot; in der <b>Information</b>-Dropdownliste der [Graphansicht](../../../../interface/the-graph-view/the-graph-view.md)-Symbolleiste aktivieren.

</td>
<td style="border: 0;" valign="top">

![Rahmen (Standardbeschreibung)](frame.resources/graph-frames-descr.png "Rahmen (Standardbeschreibung)"){zoomable="yes"}
...
Der Text kann mithilfe von HTML-Tags in der <b>Description</b>-Eigenschaft des Rahmens formatiert werden. Die Formatierung muss aktiviert werden, indem die Schaltfläche ![](frame.resources/graph-frames_html-markup-button.png) <b>HTML-Markup</b> in derselben Eigenschaft verwendet wird.

</td>
<td style="border: 0;" valign="top">

![Rahmen (HTML-formatierte Beschreibung)](frame.resources/graph-frames-descr-html.png "Rahmen (HTML-formatierte Beschreibung)"){zoomable="yes"}
...
![Frame-Einbindung: hohe Knoten](frame.resources/frame_inclusion_node_tall.png "Frame-Einbindung: hohe Knoten")
...
![Frame-Einbindung: angedockte Knoten](frame.resources/frame_inclusion_node_docked.png "Frame-Einbindung: angedockte Knoten")



![Frame-Einbindung: node](frame.resources/frame_inclusion_node.png "Frame-Einbindung: nodes")
...
![Frame-Einbindung: Punktknoten](frame.resources/frame_inclusion_dot.png "Frame-Einbindung: Punktknoten")
...
![Frame-Einbindung: übergeordnete Kommentare](frame.resources/frame_inclusion_comment_parented.png "Frame-Einbindung: übergeordnete Kommentare")



![Frame-Einbindung: comments](frame.resources/frame_inclusion_comment.png "Frame-Einbindung: Kommentare")
...
![Frame-Einbindung: Navigationsstifte](frame.resources/frame_inclusion_pin.png "Rahmeneinbindung: Navigationsstifte")
...
![Frame-Einbindung: geschachtelte Frames](frame.resources/frame_inclusion_frame.png "Frame-Einbindung: geschachtelte Frames")
...
![Frames: Größe an Inhalt anpassen](frame.resources/graph-frames_fit-size-to-content.png "Bilder: Größe an Inhalt anpassen")
...
![Frames: Größe an Inhalt anpassen (mit Beschreibung)](frame.resources/graph-frames_fit-description.png "Rahmen: Größe an Inhalt anpassen (mit Beschreibung)")
...
+++Beispiel
![Frames: Größe an Inhalt anpassen (GIF)](frame.resources/graph-frames_fit-size-to-content.gif "Rahmen: Größe an Inhalt anpassen (GIF)"){width="640px"}
...
![Frames: Automatisch erweitern](frame.resources/graph-frames_auto-expand.png "Rahmen: Automatische Erweiterung")
...
+++Beispiel
![Frames: Automatisch erweitern (GIF)](frame.resources/graph-frames_auto-expand.gif "Rahmen: Automatisch erweitern (GIF)"){width="640px"}
