...
![Punktknotensymbol](dot-node.resources/dot-node-01.png "Punktknotensymbol")
...
![Einfügen eines Punktknotens](dot-node.resources/dot-node-02.gif "Einfügen eines Punktknotens"){width="512px"}
...
![Punkt: Erstellen aus Verbindung](dot-node.resources/dot-node-03.gif "Punkt: Erstellen aus der Verbindung ")
...
![Punktknoten im Knotenmenü](dot-node.resources/dot-node-04.png "Punktknoten im Knotenmenü")
...
![Verknüpfungen zusammenführen](dot-node.resources/dot-node-05.gif "Verknüpfungen zusammenführen"){width="512px"}
...
![Punktknoten als Portal - Symbol](dot-node.resources/dot-node-06.png "Punktknoten als Portal - Symbol")
...
![Punktknoten als Portal](dot-node.resources/dot-node-07.gif "Punktknoten als Portal")
