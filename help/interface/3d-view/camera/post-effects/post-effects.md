...
Simuliert den Kameraeffekt von Lichträndern, die von sehr hellen Bereichen nach außen auf Bereiche verlaufen, die weniger Licht empfangen.

Der Effekt wird von der Beleuchtung, der Kamerabelichtung und den Emissionsmaterialien der Szene beeinflusst.

+++Schwellenwert
Der Luminanzwert, über dem die Blüte sichtbar sein soll.
...
Simuliert ein optisches Phänomen, das durch Kameraobjektive verursacht wird, bei denen Objekte, die näher und weiter als der Fokusabstand sind, unscharf werden.

Der Effekt wird sowohl von den Parametern &quot;F-Stopp&quot; als auch &quot;Fokusabstand&quot; der Kamera beeinflusst.

>[!TIP]
>
> Um den Kamerafokus schnell anzupassen, platzieren Sie den Cursor an der Stelle, an der der Fokus erfolgen soll, und drücken Sie Strg+LMB (Windows) bzw. Befehl+LMB (macOS), um den Fokusabstand automatisch auf diese Stelle einzustellen.
