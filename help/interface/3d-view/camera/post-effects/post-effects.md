...
![Post-Effekte](post-effects.resources/postEffects.png "Post-Effekte"){zoomable="yes"}

In den Eigenschaften für die Kamera können Sie Post-Effekten das Verbessern der Renderings oder das Überprüfen bestimmter Material-Eigenschaften ermöglichen.
