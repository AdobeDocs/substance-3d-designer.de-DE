...
**Substance Designer 2021.1** bietet eine Reihe neuer Funktionen mit Unterstützung von Pantone-Farben, die Möglichkeit, einen Knoten in einem Graphen zu deaktivieren, sowie den Export von tessellierten Netzen und verschiedene Verbesserungen der Lebensqualität.
...
Diese Version bietet zusätzliche Unterstützung für Pantone-Volltonfarben. Pantone ist für seine Farbpalette bekannt, die in den verschiedensten Branchen wie Grafik-Design, Mode-Design, Fertigung und vielen anderen verwendet wird. Mit dieser neuen Funktion ist es jetzt viel einfacher, die Farbe eines Materials an seinen realen Lebenswert anzupassen. Weitere Informationen finden Sie auf der dedizierten [Dokumentationsseite &#x200B;](../../color-management/spot-colors-pantone/spot-colors-pantone.md).

>[!NOTE]
>
> Um diese neuen Pantone-Farben zu verwenden, muss die Farbmanagementeinstellung in den Anwendungsvoreinstellungen auf **Adobe ACE** festgelegt werden.
...
### Neue Option zum Deaktivieren von Knoten in einem Diagramm

![](../../assets/header-disable-node.png)

In dieser Version wird die Möglichkeit hinzugefügt, einen Knoten zu deaktivieren, sodass er in einem Diagramm durchlaufen wird. Das ist nützlich, wenn du ein Material vergleichen und iterieren möchtest, um zu sehen, welche Effekte ein bestimmter Knoten zum Endergebnis hinzufügt.
