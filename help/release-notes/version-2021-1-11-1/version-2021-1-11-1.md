...
### Neuer Export von tesselliertem Mesh vom Viewport

![](version-2021-1-11-1.resources/header-export-mesh.jpg)

Der tesselierte Mesh in der 3D-Ansicht kann nun in verschiedenen Dateiformaten exportiert werden.

Verwenden Sie dazu einfach die Szene **Datei > Exportieren** in der **3D-Ansicht**. Weitere Informationen finden Sie auf der dedizierten [Dokumentationsseite &#x200B;](../../interface/3d-view/3d-view.md).
...
* **Automatische Speicherbudgetzuweisung für das Engine**\
...
* **Die 3D-Ansicht unterstützt jetzt die neue Semantik &quot;physicalSize&quot;.**\
  Benutzerdefinierte Shader können jetzt die Physische Größe eines Materials berücksichtigen, um sein Verhalten anzupassen. Weitere Informationen finden Sie in den mit der Anwendung bereitgestellten Shadern.
...
* **Ordner beim Exportieren von Bitmaps erstellen**\
  Beim Exportieren von Bitmaps aus einem Graf können Sie jetzt Schrägstriche angeben, um Ordner und Unterordner zu erstellen, wenn diese nicht vorhanden sind. So können Sie die Bitmaps pro Graf in einem eigenen Ordner organisieren, z. B. mit: **Projekt/$(Graf)/$(Identifizierung)**.

* **SBSRender unterstützt jetzt Adobe-ACE und ICC-Profile**\
  Der SBSRender-Prozess (Teil des Automation Toolkits) kann jetzt Substance-Ausgaben mit angemessenem Farbmanagement rendern, wenn das Adobe ACE-Engine verwendet wird.
