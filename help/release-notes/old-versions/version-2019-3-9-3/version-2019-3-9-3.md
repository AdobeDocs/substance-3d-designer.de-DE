...
Weitere Informationen finden Sie in der Dokumentation [Krümmung von Mesh](https://experienceleague.adobe.com/en/docs/substance-3d/bakers/bakers-settings/curvature-from-mesh).
...
Weitere Informationen finden Sie in der Dokumentation [Ambient occlusion von Mesh](https://experienceleague.adobe.com/en/docs/substance-3d/bakers/bakers-settings/ambient-occlusion-from-mesh).
