...
### Neuer wertvoller Prozessorknoten

![](../../../assets/doc-value-processor.png)

Das Substance Engine ist jetzt in der 7. Version und bringt damit das neue Konzept der &quot;Werte&quot; in den Compositing-Graphen. Werte sind Zahlen und keine Texturen und können als solche verwendet werden, um verschiedene Berechnungen durchzuführen, die über die Funktionsgraphen und Compositing-Graphen knotenübergreifend ausgetauscht werden können. Der Knoten &quot;Value Processor&quot; kann ein Eingabebild lesen und einen einzelnen Ausgabewert berechnen.

Der Knoten Wertprozessor ist nicht allein, um Informationen über das Diagramm übertragen zu können, wurden einige Änderungen und Ergänzungen vorgenommen:
...
* Ein neuer **Eingabeknoten** mit dem Namen &quot;Eingabewert&quot; wurde hinzugefügt, damit das Diagramm Werte abfragen kann.
...
* Unter den Parametern der Knoten befindet sich jetzt eine neue Kategorie namens &quot;Eingabewerte&quot;, mit der Eingabewerte für den Knoten selbst erstellt werden können.\
  Die Eingangswerte können dann innerhalb des Funktionsgraphen über die &quot;Get&quot;-Knoten referenziert werden.

  ![](../../../assets/input-value-function.png)

>[!NOTE]
>
> Wie bei jeder größeren Änderung des Substance Engine wird der Kompatibilitätsmodus auf die vorherige Version eingestellt (neue Version 6 standardmäßig). Das bedeutet, dass inkompatible Knoten einen gelben Rand im Diagramm haben. Um den gelben Rahmen zu deaktivieren/auszublenden, ändern Sie einfach die Version der Engine in den Haupteinstellungen in die neueste Version (über die Projekteinstellungen) :
> 
> ![](../../../assets/doc-compat.png)

### Unterstützung von Optix in Bakers

![](../../../assets/baking-speed.jpg)

Mit dem letzten Update von Substance Designer wurde DXR eingeführt, das die Ausführung von GPU-Raytracing auf kompatibler RTX-kompatibler Hardware ermöglicht. Wir haben jetzt Unterstützung für [Optix](https://developer.nvidia.com/optix) hinzugefügt, die es ermöglicht, auf anderen Nvidia-GPUs auch unter Linux Raytracing durchzuführen. Bei Verwendung von Optix können Sie erwarten, dass das Backen mindestens **5 Mal schneller ist** als bei normalem CPU-Raytracing.

Hier ist die Liste der Bäcker, die von dieser Änderung betroffen sind:
...
* **Flood Fill in Index**\
  ...
  Im folgenden Beispiel passt der Knoten Pixelprozessor die Werteingabe an die Form an und gibt als Ergebnis eine Maske aus.

  ![](../../../assets/flood-fill-index-optim.gif)
* **Non Uniform Directional Warp**\
  Wendet eine Richtungsverkrümmung an, bei der die Intensität und der Winkel von den Bildeingaben aufgenommen werden.

  ![](../../../assets/warp-non-uniform-optim.gif)
* **Multidirektionale Verkrümmung**\
  Verzerrt das Eingabebild mehrmals in verschiedene Richtungen.

  ![](../../../assets/warp-demo.gif)
* **Höhenextrusion**\
  Generiert ein orthografisches 3D-Rendering des angegebenen Heights. Die Kameraansicht kann mit dem Positions-Gizmo gesteuert werden.
