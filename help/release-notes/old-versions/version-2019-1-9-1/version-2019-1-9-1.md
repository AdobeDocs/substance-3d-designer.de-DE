...
Wenn Sie eines der beiden Backends deaktivieren möchten, navigieren Sie zu den Hauptvoreinstellungen (**Bearbeiten > Voreinstellungen**) und zu den Einstellungen für Baker :
...
> 
> Beachten Sie, dass DXR auch auf [GeForce GTX 10xx GPUs](https://www.nvidia.com/en-us/geforce/news/geforce-gtx-dxr-ray-tracing-available-now/) (mit aktuellen Treibern) verfügbar ist. DXR Windows muss auch auf dem neuesten Stand sein, um zu arbeiten. Weitere Informationen finden Sie unter [dieser Seite](../../../best-practices/performance-optimization/performance-optimization-guidelines.md).

### Verbesserte Ladezeiten für OBJ Mesh

![](../../../assets/doc-obj-loading.jpg)

In dieser Version haben wir unseren **obj**-Dateileser verbessert, um die Ladezeit von 3D-Meshs zu reduzieren. Die Ladezeiten wurden bis zu dreimal beschleunigt, insbesondere für Mesh, für die keine UVs und Normale definiert sind.

Diese Leistungsverbesserung wird sich sowohl auf die Baker als auch auf die 3D-Ansicht auswirken.
...
In der Standardbibliothek sind auch einige neue Wertprozessor verfügbar, von denen einige jetzt mit dem neuen Knoten unterstützt werden:
