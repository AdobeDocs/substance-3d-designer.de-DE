...
[Kegel](./sdf-functions-primitives/3d-sdf-cone/3d-sdf-cone.md)\
...
[Boden-Ebene](./sdf-functions-primitives/3d-sdf-ground-plane/3d-sdf-ground-plane.md)\
...
[Quadrat der Pyramide](./sdf-functions-primitives/3d-sdf-pyramid-square/3d-sdf-pyramid-square.md)\
...
* **Andere spezialisierte**-Operatoren wie [Shell](sdf-functions-operators/3d-sdf-op-shell/3d-sdf-op-shell.md) und [Symmetrie](sdf-functions-operators/3d-sdf-op-symmetry/3d-sdf-op-symmetry.md), mit denen Sie eine Form ändern und/oder duplizieren können.
