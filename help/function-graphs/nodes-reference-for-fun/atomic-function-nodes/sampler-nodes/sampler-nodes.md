...
breadcrumb-title: ''
description: Greifen Sie auf Samplerknoten in Substance 3D Designer-Funktions-Grafen zu, um Texturen zu testen und Farbwerte zu extrahieren.
...
![Sampler-Knoten](sampler-nodes.resources/image2016-1-12-14-45-43.png "Sampler-Knoten")

Diese Knoten nehmen einen Wert in einem Eingabebild an den angegebenen 2D-Koordinaten auf:

<b>Sample Gray</b> ermittelt einen Wert für die Luminanz an der Eingabe <b>Position</b> in einem Graustufenbild und gibt diesen als <b>Fließkommazahl</b>-Wert aus.
...
![Pixelkoordinaten](sampler-nodes.resources/samplercoords.png "Pixelkoordinaten")
...
Die Nummerierung der Eingänge beginnt bei 0, sodass ein Bild, das mit dem ersten Eingang des Knotens verbunden ist, als *Eingabebild 0* aufgelistet wird.
...
<b>An Edge Beschränkt</b>\
Beschränkt Werte außerhalb des Bereichs [0;1] bis zum nächsten Grenzwert hoch.\
