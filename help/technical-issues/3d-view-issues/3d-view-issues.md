...
Der [Tipp in diesem Abschnitt &#x200B;](../../interface/3d-view/displacement/displacement.md#per-mesh) behebt das Leistungsproblem, indem der Tessellation-Prozess für `Mesh` Objekte in der Szene deaktiviert wird.
