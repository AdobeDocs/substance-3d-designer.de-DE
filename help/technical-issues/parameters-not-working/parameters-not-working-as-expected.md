...
![(Fehler)](parameters-not-working-as-expected.resources/error.svg) <b>Problem</b>
...
![(tick)](parameters-not-working-as-expected.resources/check.svg) <b>Empfohlene Schritte</b>
...
| Knoten | Parameter |
|:---------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------|
| Alle Knoten | Kachelung, Pixelverhältnis |
...
Ein auf einen Knotenparameter angewendeter Substance-Funktions-Graf gibt nicht den erwarteten Wert aus, wenn eine *negative Ganzzahl* verwendet wird.

![(tick)](parameters-not-working-as-expected.resources/check.svg) <b>Empfohlene Schritte</b>

Negative Ganzzahlen werden derzeit nicht ordnungsgemäß unterstützt. Verwenden Sie als Problemumgehung den negativen Wert für die Ganzzahl in einem [Ganzzahl2](../../function-graphs/nodes-reference-for-fun/atomic-function-nodes/constant-nodes/constant-nodes.md)-Wert, und extrahieren Sie ihn mithilfe eines [Swizzle-Ganzzahl](../../function-graphs/nodes-reference-for-fun/atomic-function-nodes/vector-and-swizzle-nodes/vector-and-swizzle-nodes.md)-Knotens.
