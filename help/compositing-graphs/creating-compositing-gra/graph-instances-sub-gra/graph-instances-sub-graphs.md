...
Beachten Sie, dass Sie, wenn die ausgewählten Knoten mit anderen Knoten im Diagramm verbunden waren, im neuen Diagramm auch [Eingangs-](../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/input-color/input-color.md) und [Ausgangsknoten](../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/output/output.md) erstellen sollten, um diese Verbindungen mit dem Untergraph zu übertragen.
