...
* Knoten [Eingabe](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/input-color/input-color.md) eines Diagramms;
* Knoten &quot;[Output](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/output/output.md)&quot; eines Diagramms.

![Sichtbarkeit von Eingabeparametern umschalten](visible-if-control-visibility-of-inputs-outputs-and-parameters.resources/visible-if-example.gif "Sichtbarkeit von Eingabeparametern umschalten"){width="512px"}
