...
1. Klicken Sie auf <b>OK</b>, um alle ausgewählten Parameter zu bestätigen und anzuzeigen. Die Parameternamen zeigen jetzt *blau* an, um zu bestätigen, dass die Parameter angezeigt werden, sowie eine ![](exposing-a-parameter.resources/image2020-9-17-15-35-46.png) <b>Schaltfläche zum Bearbeiten der Funktion</b>.
...
1. Klicken Sie auf die Schaltfläche &quot;Dropdown-Optionen&quot; ![](exposing-a-parameter.resources/image2020-9-17-15-35-59.png) neben dem bereits angezeigten Parameter.
1. Wählen Sie &quot;![](exposing-a-parameter.resources/image2020-9-17-15-37-7.png)<b>&quot; aus, um den angezeigten Diagrammeingang zu bearbeiten.</b>. Dadurch gelangen Sie direkt zum entsprechenden Eintrag in den Diagrammeigenschaften.
...
![Eingabeparameter](exposing-a-parameter.resources/input-parameters-2.png "Eingabeparameter"){width="512px"}
...
![Dropdownlisten-Editor für Integer-Parameter](exposing-a-parameter.resources/dropdown.gif "Dropdownlisten-Editor für Integer-Parameter"){width="512px"}
...
![Eingabeparameter neu anordnen](exposing-a-parameter.resources/reorder-2.gif "Eingabeparameter neu anordnen"){width="512px"}
...
![Vorschau der Eingabeparameter](exposing-a-parameter.resources/parameter-preview-2.gif "Vorschau der Eingabeparameter"){width="512px"}
...
![Eingabeparameter werden kopiert und eingefügt](exposing-a-parameter.resources/copy-paste-params-2.gif "Eingabeparameter werden kopiert und eingefügt"){width="512px"}

### KOPIEREN UND EINFÜGEN VON PARAMETERN

Parameter können zwischen Graphen kopiert und eingefügt werden.

Ein einzelner Parameter kann mit der Schaltfläche &quot;Kopieren&quot; ![](exposing-a-parameter.resources/image2019-9-19-11-3-49.png) kopiert werden. Mehrere Parameter können über das Parametermenü &quot;![](exposing-a-parameter.resources/image2020-9-17-15-39-7.png)&quot; kopiert werden. Wählen Sie &quot;Eingaben kopieren&quot;, um alle Eingaben zu kopieren.

Wählen Sie &quot;Eingaben einfügen&quot; ![](exposing-a-parameter.resources/image2020-9-17-16-43-15.png) im Menü &quot;Parameter&quot; ![](exposing-a-parameter.resources/image2020-9-17-15-39-7.png), um einen oder mehrere Parameter einzufügen.
...
![Fehler bei Knotenparametern](exposing-a-parameter.resources/parameter-error.gif "Fehler bei Knotenparametern"){width="512px"}

### VERFOLGEN VON FEHLERHAFTEN PARAMETERN AUF KNOTEN

Mit dem Knotensuche-Tool &quot;![](exposing-a-parameter.resources/image2019-9-19-14-15-53.png)&quot;, das sich in der oberen Leiste der Diagrammansicht befindet, können Sie nachverfolgen, welcher Parameter von welchem Knoten verwendet wird. Klicken Sie darauf, um Knoten mithilfe bestimmter Parameter zu suchen.
...
![Parameter werden entfernt](exposing-a-parameter.resources/delete-param-2.gif "Parameter werden entfernt"){width="512px"}
