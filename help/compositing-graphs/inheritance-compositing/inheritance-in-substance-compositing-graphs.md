...
* Wenn dieser Graf ein untergeordneter Graf ist, der als *Instanzknoten* in einen anderen Host-Graf instanziieren ist, ist der übergeordnete Graf des untergeordneten Instanzknotens der **. Das übergeordnete Element dieses Instanzknotens ist das *Hostdiagramm*.
