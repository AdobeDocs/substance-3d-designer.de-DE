...
![Elementare Knoten: Graustufen](input-grayscale.resources/comp_inputgrayscale_1.png "Elementare Knoten eingeben: Eingabe-Graustufen"){width="100%"}
...
<td style="border: 0; text-align: center" align="center"><img src="input-grayscale.resources/input-grayscale-tooltip.gif" alt="QuickInfo für Graustufen-Eingabe" /></td>
<td style="border: 0; width: 15%" width="15%"></td>
</tr>
</table>
