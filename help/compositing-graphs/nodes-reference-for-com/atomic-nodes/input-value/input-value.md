...
breadcrumb-title: ""
description: Verwenden Sie den Knoten "Eingabewert", um Wert-Eingabeparameter für Substance-Graf zu erstellen, die von Benutzern gelegt und angepasst werden können.
...
![Atomknoten: Eingabewert ](input-value.resources/comp_inputnumeric_1.png "Atomischer Knoten: Eingabewert "){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-value.resources/input-value-tooltip.gif" alt="QuickInfo für Eingabewert" /></div>
...
![Primäre Eingabe in Substance-Graf ](input-value.resources/node-primary-input.png){width="20%"}
