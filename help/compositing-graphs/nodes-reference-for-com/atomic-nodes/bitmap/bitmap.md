...
![Atomknoten: Bitmap](bitmap.resources/comp_bitmap.png "Atomischer Knoten: Bitmap"){width="100%"}
...
<td style="border: 0; text-align: center"><img src="bitmap.resources/bitmap-tooltip.gif" alt="Bitmap-QuickInfo" /></td>
<td style="border: 0; width: 15%"></td>
</tr>
</table>
