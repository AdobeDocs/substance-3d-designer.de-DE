...
<div data-preserve-html="true" align="center"><img src="bitmap.resources/bitmap-tooltip.gif" alt="Bitmap-QuickInfo" /></div>
...
| <b>Methode zur Größenänderung</b> *Ganzzahl* | Die Neuberechnungsmethode für das Hoch- oder Herunterskalieren einer Bitmap:<ul data-preserve-html="true"> <li data-preserve-html="true"><i>Nahtlos gedehnt:</i> Wenden Sie [bilineare Filterungen](../../../../glossary/glossary.md) an, um die Quellpixel des gedehnt Bildes zu interpolieren.</li> <li data-preserve-html="true"><i>Nächstliegender dehn:</i> Das Bild wurde Gedehnt und die Farbe des nächstliegenden Quellpixel wird unverändert verwendet.</li> </ul> |
