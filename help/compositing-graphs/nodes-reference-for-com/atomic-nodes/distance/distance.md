...
![Elementare Knoten: Distanz](distance.resources/comp_distance_1.png "Elementare Knoten: Entfernung"){width="100%"}
...
<td style="border: 0; text-align: center"><img src="distance.resources/distance-tooltip.gif" alt="Entfernungs-QuickInfo" /></td>
<td style="border: 0; width: 15%"></td>
</tr>
</table>
