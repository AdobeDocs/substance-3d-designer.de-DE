...
![Elementare Knoten: Transformation 2D](transformation-2d.resources/comp_transformation_1.png "Elementare Knoten: Transformation 2D"){width="100%"}
...
| <b>Mipmap-Stufe</b> *Ganzzahl* | Legt die zu verwendende [Mipmap](../../../../glossary/glossary.md)-Ebene fest.     *Verfügbar, wenn &#39;Mipmap mode&#39; auf &#39;Manual&#39; festgelegt ist* |
| <b>Matte Farbe</b> *Fließkommazahl4* | Die Farbe, die als Hintergrund verwendet wird, wenn die Kachelung der Transformation deaktiviert ist. Legt also die Farbe fest, die verwendet wird, wenn die transformieren Eingabe einen Bereich der Ausgabe nicht abdeckt.   Kann transparent gemacht werden, wenn mit RGBA-Farbe gearbeitet wird. |
| <b>Filterung</b> *Ganzzahl* | Legt die verwendete Neuberechnungsmethode fest. Funktioniert nicht besonders gut, wenn die Mipmap-Stufe reduziert wird. |

## Eingabe-Verbindungen

|  |  |
| --- | --- |
| <b>Eingabe</b> *Graustufen/Farbe* PRIMÄR | Das zu transformieren Bild. |
