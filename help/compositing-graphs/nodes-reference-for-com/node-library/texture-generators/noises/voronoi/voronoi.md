...
* **Intensität der Verzerrung** *Gleitend*\
  Steuert die Intensität eines *Verkrümmungseffekts*, der auf das Voronoi-Rauschen angewendet wird.
...
* **Stil** *Ganzzahl* Legt die Methode *fest, die die Daten* des Voronoi-Rauschens rendert, da das Rauschen auf einem Satz von Punkten im Raum basiert:
...
* **Kantenzelle** *Unverankert* Passt die Thickness der Thicknessen an, die zwischen den Zellen des Voronoi-Rauschens erkannt werden. Kanten werden in der X-, Y- und Z-Achse erkannt, daher können einige Stärken schneller zunehmen als andere, je nach *Tiefe* der Zellen.\
...
* **Quadratische Ausbreitung** *Boolesch*\
