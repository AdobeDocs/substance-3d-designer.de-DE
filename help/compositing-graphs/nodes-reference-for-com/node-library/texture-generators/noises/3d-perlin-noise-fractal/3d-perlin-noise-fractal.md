...
breadcrumb-title: ""
description: Verwenden Sie den 3D-Knoten Perlin Rauschen Fractal , um fraktale Perlin-Rauschen-Muster im 3D-Raum für die Erstellung detaillierter volumetrischer Texturen zu generieren.
...
Der Knoten <b>3D Perlin Rauschen Fraktal</b> generiert eine <i>Fraktal</i> Perlin-Rauschen im 3D-Raum auf der Grundlage der <b>Positionszuordnung</b>-Eingabe.
...
| <b>Skalierung</b> <i>Fließkommazahl</i> | Steuert die Skalierung der fraktalen 3D-Perlin-Rauschen. |
| <b>Größe</b> <i>Fließkommazahl3</i> | Steuert die Größe der fraktalen 3D-Perlin-Rauschen in den Achsen <b>X</b>, <b>Y</b> und <b>Z</b>. Nicht einheitliche Werte führen zu einem <i> dehnend oder zerdrückenden </i>-Effekt. |
| <b>Offset</b> <i>Fließkommazahl3</i> | Wendet einen Offset auf die <i>Position</i> der fraktalen 3D-Perlin-Rauschen in den Achsen <b>X</b>, <b>Y</b> und <b>Z</b> an. |
| <b>Intensität der Verzerrung</b> <i>Fließkommazahl</i> | Steuert die Intensität eines <i>Verkrümmungseffekts</i>, der auf die fraktale 3D-Perlin-Rauschen angewendet wird. |
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="3d-perlin-noise-fractal.resources/3dfractal.gif" class="modal-image" alt="3D Perlin Rauschen Fraktal - Beispiel 1" />
        </td>
        <td style="border: 0;">
            <img src="3d-perlin-noise-fractal.resources/3dperlinnoisefractal-variant.jpg" class="modal-image" alt="3D Perlin Rauschen Fraktal - Beispiel 2" />
        </td>
        <td style="border: 0;">
            <img src="3d-perlin-noise-fractal.resources/3dperlinnoisefractal-variant2.jpg" class="modal-image" alt="3D Perlin Rauschen Fraktal - Beispiel 3" />
        </td>
    </tr>
</table>
