---
helpx_url: "https://helpx.adobe.com/de/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/cells-1.html"
breadcrumb-title: ''
...
![Zellen 1 - Symbol](../../../../../../assets/cells_1.png "Zellen 1 - Symbol"){width="200px"}
...
| <b>Muster</b> <i>Integer</i> | Die Grundform, die im generierten Bild gestreut wird. |
| <b>Mustergröße</b> <i>Float2</i> | Ein Multiplikator für die Größe eines gestreuten Musters in seiner Zelle., wobei 1,0 die volle Spanne der Zelle ist. |
| <b>Musterskala</b> <i>Gleitend</i> | Ein Multiplikator für die <b>Mustergröße</b>, wobei 1,0 die volle Größe ist. |
| <b>zufällige Luminanz</b> <i>Gleitend</i> | Der Bereich der Luminanz, der zufällig von den Zellen subtrahiert wird, wobei 1 der gesamte Bereich ist. |
| <b>Winkel</b> <i>Gleitend</i> | Der Winkel, der zum Festlegen der Richtung der Zellen verwendet wird, in der Anzahl der Windungen und ausgehend von der horizontalen rechten Seite. |
...
![Zellen 1 - Beispiel 1](../../../../../../assets/cells_1_1.png "Zellen 1 - Beispiel 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Zellen 1 - Beispiel 2](../../../../../../assets/noise_cells_1_v2_speed0.3_aniso0.3.gif "Zellen 1 - Beispiel 2"){zoomable="yes"}
...
![Zellen 1 - Beispiel 3](../../../../../../assets/noise_cells_1_v2_speed0.5_aniso0.6.gif "Zellen 1 - Beispiel 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Zellen 1 - Beispiel 4](../../../../../../assets/noise_cells_1_v2_speed0.3_aniso0.6.gif "Zellen 1 - Beispiel 4"){zoomable="yes"}
