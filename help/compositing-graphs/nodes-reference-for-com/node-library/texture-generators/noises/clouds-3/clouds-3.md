---
helpx_url: "https://helpx.adobe.com/de/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/clouds-3.html"
breadcrumb-title: ''
description: Verwenden Sie den Knoten Wolken 3, um erweiterte Cloud-Muster zu generieren, um atmosphärische und volumetrische Textureffekte zu erzeugen.
...
![Clouds 3 - Symbol](clouds-3.resources/clouds_3.png "Clouds 3 - Symbol"){width="200px"}
...
![Clouds 3 - Beispiel 1](clouds-3.resources/clouds_3_1.png "Clouds 3 - Beispiel 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Clouds 3 - Beispiel 2](clouds-3.resources/noise_clouds_3_v2_speed0.6_aniso0.gif "Clouds 3 - Beispiel 2"){zoomable="yes"}
...
![Clouds 3 - Beispiel 3](clouds-3.resources/noise_clouds_3_v2_speed0.6_aniso1.gif "Clouds 3 - Beispiel 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Clouds 3 - Beispiel 4](clouds-3.resources/noise_clouds_3_v2_speed0.3_aniso0.6.gif "Clouds 3 - Beispiel 4"){zoomable="yes"}
