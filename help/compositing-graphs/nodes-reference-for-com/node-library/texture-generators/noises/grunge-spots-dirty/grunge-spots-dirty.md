...
Der **Schmutz Spots Dirty**-Knoten generiert eine Schmutz-Map, die mit Spots des Dirts vergleichbar ist.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-spots-dirty.resources/grungespotsdirty-variant2.jpg" class="modal-image" alt="Schmutz Spots Dirty - Beispiel 1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-spots-dirty.resources/grungespotsdirty-variant.jpg" class="modal-image" alt="Schmutz Spots Dirty - Beispiel 2" />
        </td>
