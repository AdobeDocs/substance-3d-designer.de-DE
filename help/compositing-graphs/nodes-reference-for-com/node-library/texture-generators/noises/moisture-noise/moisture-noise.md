...
![Feuchtigkeitsrauschen 1 - Symbol](moisture-noise.resources/moisture_noise_1.png "Feuchtigkeitsrauschen 1 - Symbol"){width="200px"}
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="moisture-noise.resources/moisture_noise_1_1.png" class="modal-image" alt="Feuchtigkeit Rauschen 1 - Beispiel 1" />
        </td>
        <td style="border: 0;">
            <img src="moisture-noise.resources/noise_moisture_noise_1_v2_speed0.6_aniso0.gif" class="modal-image" alt="Feuchtigkeit Rauschen 1 - Beispiel 2" />
        </td>
        <td style="border: 0;">
            <img src="moisture-noise.resources/noise_moisture_noise_1_v2_speed0.6_aniso1.gif" class="modal-image" alt="Feuchtigkeit Rauschen 1 - Beispiel 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="moisture-noise.resources/noise_moisture_noise_1_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="Feuchtigkeit Rauschen 1 - Beispiel 4" />
        </td>
