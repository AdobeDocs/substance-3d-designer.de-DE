...
![Clouds 2 - Symbol](clouds-2.resources/clouds-2-01.png "Clouds 2 - Symbol"){width="200px"}
...
![Clouds 2 - Beispiel 1](clouds-2.resources/clouds-2-02.png "Clouds 2 - Beispiel 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Clouds 2 - Beispiel 2](clouds-2.resources/clouds-2-03.gif "Clouds 2 - Beispiel 2"){zoomable="yes"}
...
![Clouds 2 - Beispiel 3](clouds-2.resources/clouds-2-04.gif "Clouds 2 - Beispiel 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Clouds 2 - Beispiel 4](clouds-2.resources/clouds-2-05.gif "Clouds 2 - Beispiel 4"){zoomable="yes"}
