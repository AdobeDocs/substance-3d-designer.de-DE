---
helpx_url: "https://helpx.adobe.com/de/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/patterns/brick-2.html"
breadcrumb-title: ''
description: Verwenden Sie den Knoten Brick 2, um erweiterte Ziegelmuster mit erweiterten Steuerelementen für die Erstellung realistischer Mauerwerktexturen zu generieren.
...
* **Edge-Smoothness**: *0.0 - 1.0* Vermischt harte und glatte Kanten.
* **Schnittstellenbreite**: *0.0 - 1.0* Setzt Zwischenraum (Lückengröße).
