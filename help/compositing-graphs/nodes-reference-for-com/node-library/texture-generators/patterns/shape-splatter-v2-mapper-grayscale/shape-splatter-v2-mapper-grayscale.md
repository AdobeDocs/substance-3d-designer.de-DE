...
description: Designer > Substance von Compositing-Graphen > Knotenreferenz für Substance-Compositing-Graphen > Knotenbibliothek > Generator > Muster > Shape-Splater v2 mapper grayscale
...
|                                     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|:------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>Rasteratlas-Eingabe</b> *Graustufen* | Ein Graustufenbild von Mustern, die in einem Rasterlayout zusammengefasst sind.<br><br>Die Rastergröße muss mit der Größe übereinstimmen, die vom Knoten [Shape splatter v2](../shape-splatter-v2/shape-splatter-v2.md) verwendet wird.<br><br>Verwenden Sie den Knoten [Rasteratlas grayscale](../grid-atlas-grayscale/grid-atlas-grayscale.md), um separate Muster in einen Rasteratlas zu packen. |
| <b>Mustereingabe 1</b> *Graustufen* | Das Graustufenbild für das #1, das den Formen zugeordnet ist.<br><br><i>Tipp:</i> Verwenden Sie eine Auflösung, die der maximalen Größe des Musters beim Streuen nahe kommt. |
| <b>Mustereingabe 2</b> *Graustufen* | Das Graustufenbild für das #2, das den Formen zugeordnet ist.<br><br><i>Tipp:</i> Verwenden Sie eine Auflösung, die der maximalen Größe des Musters beim Streuen nahe kommt. |
| <b>Mustereingabe 3</b> *Graustufen* | Das Graustufenbild für das #3, das den Formen zugeordnet ist.<br><br><i>Tipp:</i> Verwenden Sie eine Auflösung, die der maximalen Größe des Musters beim Streuen nahe kommt. |
| <b>Mustereingabe 4</b> *Graustufen* | Das Graustufenbild für das #4, das den Formen zugeordnet ist.<br><br><i>Tipp:</i> Verwenden Sie eine Auflösung, die der maximalen Größe des Musters beim Streuen nahe kommt. |
| <b>Mustereingabe 5</b> *Graustufen* | Das Graustufenbild für das #5, das den Formen zugeordnet ist.<br><br><i>Tipp:</i> Verwenden Sie eine Auflösung, die der maximalen Größe des Musters beim Streuen nahe kommt. |
| <b>Mustereingabe 6</b> *Graustufen* | Das Graustufenbild für das #6, das den Formen zugeordnet ist.<br><br><i>Tipp:</i> Verwenden Sie eine Auflösung, die der maximalen Größe des Musters beim Streuen nahe kommt. |
| <b>Mustereingabe 7</b> *Graustufen* | Das Graustufenbild für das #7, das den Formen zugeordnet ist.<br><br><i>Tipp:</i> Verwenden Sie eine Auflösung, die der maximalen Größe des Musters beim Streuen nahe kommt. |
| <b>Mustereingabe 8</b> *Graustufen* | Das Graustufenbild für das #8, das den Formen zugeordnet ist.<br><br><i>Tipp:</i> Verwenden Sie eine Auflösung, die der maximalen Größe des Musters beim Streuen nahe kommt. |
| <b>Hintergrundeingabe</b> *Graustufen* | Das als Hintergrund für die zugeordneten Formen verwendete Graustufenbild. |
| <b>Farbeingabe</b> *Graustufen* | Das Graustufenbild, das zum Aufhellen der zugeordneten Formen entsprechend ihrer Pivot-Position verwendet wird.<br><br>Verwenden Sie den Parameter <b>Deckkraft für Farbeingabe</b>, um die Intensität des Beitrags dieser Farben zur Formenfarbe anzupassen. |
...
| <b>Eingabeauswahlmodus</b> *Integer* | Die Methode zum Auswählen, welche der Eingabebilder den Formen zugeordnet werden sollen.<br><br>Der <b>Shape-Typ</b>, der im Quellknoten [Shape splatter v2](../shape-splatter-v2/shape-splatter-v2.md) ausgewählt ist, ändert die Art und Weise, wie Rasteratlasse Formen zugewiesen werden:<br><br>- <b>Rasteratlas</b> bedeutet, dass die Bilder in der &#39;Mustereingabe&#39; durch übereinstimmende Rasterindizes abgerufen werden (beide Atlanten sollten die gleiche Rastergröße verwenden)<br>- <b>Mustereingabe</b> bedeutet, dass die Bilder in den &#39;Mustereingabe #&#39;-Eingaben durch übereinstimmende Indizes abgerufen werden.<br>- <b>Andere Formtypen: </b> Bilder werden zugewiesen, indem die Indizes mit den Material-IDs der Form übereinstimmen.<br><br>Die verfügbaren Auswahlmethoden für die Indizes sind:<br>- <b>Aus Spritzdaten:</b> Ordnen Sie die Indizes der Rasteratlasse &quot;Pattern input #&quot; oder &quot;Pattern input&quot; den Indizes der Formen zu, die vom Knoten [Shape splatter v2](../shape-splatter-v2/shape-splatter-v2.md) zugewiesen werden.<br>- <b>Handbuch:</b> Verwenden Sie den durch den Index angegebenen Index. Parameter &quot;Image index&quot;.<br>- <b>Random:</b> Verwenden Sie einen zufälligen Index in dem Bereich, der durch den Parameter &quot;Random range&quot; angegeben wird. |
