...
|  |  |
| --- | --- |
| <b>Height</b> *Graustufen* PRIMÄR | Die Graustufenbildeingabe, die zum Zuordnen des *Heights* - d. h. der Z-Position - der Scheitelpunkte verwendet wird.    Der Einfluss dieser Eingabe wird durch den Parameter &#39;Height Input Multiplier&#39; gesteuert. |
| <b>Vektorzuordnung</b> *Farbe* | Die Farbbildeingabe, die zum Zuordnen des *Versatzes* der Scheitelpunkte auf der X- und Y-Achse verwendet wird.    Die X/Y-Versätze werden jeweils den R/G-Kanälen des Bildes zugeordnet.    Der Einfluss dieser Eingabe wird über den Parameter &quot;Vector Map Versatz&quot; gesteuert. |
| <b>Farbeingabe</b> *Farbe* | Die Farbbildeingabe, die zum Zuordnen der *Farbe* der Scheitelpunkte, Segmente oder Dreiecke verwendet wird.    Diese Eingabe wird verwendet, wenn der Parameter &quot;Farbquelle&quot; auf &quot;Farbeingabe&quot; festgelegt ist. |

## Ausgangsanschlüsse

|  |  |
| --- | --- |
| <b>Ausgabe</b> *Farbe* | Das Ausgabebild. |
...
| <b>Drehung</b> *Gleitend* | Wendet die angegebene **-Drehung auf jeden Scheitelpunkt um seine *Grundposition* an, d. h. seine Position *vor dem zufälligen Versatz* und dem Versatz.    Diese Drehung *stapelt* mit dem Parameter <b>Rotationsstörung</b>. |
...
![Triangle Grid: Beispiel 1](../../../../../../assets/triangle_grid_color_example_1.jpg "Triangle Grid: Beispiel 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Triangle Grid: Beispiel 2](../../../../../../assets/trianglegrid-variant2.png "Triangle Grid: Beispiel 2"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Triangle Grid: Beispiel 3](../../../../../../assets/trianglegridcolor-variant2.jpg "Triangle Grid: Beispiel 3"){zoomable="yes"}
...
![Triangle Grid: Beispiel 4](../../../../../../assets/triangle_grid_color_example_2.jpg "Triangle Grid: Beispiel 4"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Triangle Grid: Beispiel 5](../../../../../../assets/trianglegridcolor-variant4.jpg "Triangle Grid: Beispiel 5"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Triangle Grid: Beispiel 6](../../../../../../assets/trianglegridcolor-variant3.jpg "Triangle Grid: Beispiel 6"){zoomable="yes"}
...
![Triangle Grid: Leder](../../../../../../assets/trianglegrid-demo.png "Triangle Grid: Leder"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Triangle Grid: Graph](../../../../../../assets/trianglegrid-node.png "Triangle Grid: Diagramm"){zoomable="yes"}
