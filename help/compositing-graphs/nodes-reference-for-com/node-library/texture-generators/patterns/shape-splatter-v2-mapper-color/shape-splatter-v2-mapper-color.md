...
|                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|:-------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>Projektion-Modus</b> *Ganzzahl* | Verfahren zum Projizieren der Eingabebilder auf die Formen:<br><br>- <b>Von Sputter-UVs:</b> Verwenden Sie die UVs, die vom Knoten &#39;Shape Spater v2&#39; bereitgestellt werden.<br>- <b>Triplanar:</b> Verwenden Sie triplanare Projektion, um die Bilder auf den lokalen XYZ-Achsen der Formen zuzuordnen.<br>- <b>Benutzerdefinierte Funktion:</b> Erstellen Sie einen Funktionsfunktionstyp, um die Zuordnung der Grafen zu den Formen zu definieren. |
| <b>Benutzerdefinierte Funktion</b> *Fließkommazahl4* | Gibt die RGBA-Pixelfarbe der Formen als Fließkommazahl4 an.<br><br>Die folgenden Variablen sind verfügbar:<br>- <code>shape.position.os</code> (Fließkommazahl3) Die Position der Formoberfläche im Objektraum.<br>- <code>shape.position.ws</code> (Fließkommazahl3) Die Position der Formoberfläche in Welt-Raum*.<br>- <code>shape.normal.os</code> (Fließkommazahl3) Die Normalen der Formoberfläche im Objektraum.<br> - <code>shape.normal.ws</code> (Fließkommazahl3) Die Normalen der Formoberfläche in Welt-Raum*.<br>- <code>shape.id</code> (Fließkommazahl) Die eindeutige Identifizierung der Form.<br>- <code>Material.id</code> (Fließkommazahl) Die Material-ID der Formoberfläche, definiert durch den Knoten &quot;Shape splatter v2&quot;.<br><br>*: Der Welt-Raum der Form ist auf dem Drehpunkt zentriert und berücksichtigt nicht das Height der Form. Das bedeutet, dass der einzige Unterschied zum Objektraum die Ausrichtung ist.<br><br>Wenn die Eingaben des Knotens &#39;Shape Splater v2 Mapper Color&#39; gesampelt werden müssen, können die folgenden <b>Sample color</b>-Knoteneingabeslots verwendet werden:<br>- 0: Rasteratlas <br>- 1-8: Mustereingabe 1-8 |
| <b>Ist Normalen-Map</b> *Boolescher Wert* | Gibt an, ob es sich bei den für die <b>Rasteratlas-Eingabe</b> oder die <b>Mustereingabe #</b> bereitgestellten Bildern um Normalzuordnungen handelt.<br><br>Dies ist erforderlich, um die Verarbeitung zu aktivieren, die für die korrekte Verarbeitung der normalen Vektoren und deren Anwendung auf die Formen erforderlich ist. |
