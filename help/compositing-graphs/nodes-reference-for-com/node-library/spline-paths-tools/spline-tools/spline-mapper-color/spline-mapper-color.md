...
# Spline-Zuordnungsfarbe

<table>
<tr style="border: 0;">
<td width="33.33%" style="border: 0;" valign="top">

![Knotensymbol](spline-mapper-color.resources/spline-mapper-color-icon.png "Knotensymbol")
...
Ordnet ein Eingabefarbbild einer primitiven Form zu, die entlang der Eingabesplines gestreckt ist.
...
Der Knoten gibt das zugeordnete Bild als Farbbild sowie weitere Informationen wie Height, UVs (d. h. Bildkoordinaten) und eine ID-Maske aus, mit der jeder zugeordnete Spline einzeln ausgewählt werden kann.
...
>[!NOTE]
>
> Siehe auch [Spline Mapper Graustufen](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/spline-tools/spline-mapper-grayscale/spline-mapper-grayscale.md).
...
|  |  |
|:---|:---|
| <b>Farbe</b> <i>Farbe</i> | Das Ergebnis der Zuordnung des Eingabefarbbilds über die Eingabesplines als Farbbild. |
...
| <b>Hintergrundfarbe</b> <i>Float4</i> | Die Hintergrundfarbe in der Farbausgabe. |
...
![Knotenbeispiel 2](spline-mapper-color.resources/SplineMapperColor-Demo.gif "Knotenbeispiel 2")
...
![Knotenbeispiel 3](spline-mapper-color.resources/SplineMapperColor-Variant1-After1.jpg "Knotenbeispiel 3")
