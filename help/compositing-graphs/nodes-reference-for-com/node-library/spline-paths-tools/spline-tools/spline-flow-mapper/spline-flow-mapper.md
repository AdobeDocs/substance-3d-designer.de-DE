...
breadcrumb-title: ''
description: Verwenden Sie den Knoten "Spline-Flow-Mapper", um Fließmuster entlang von Spline-Pfaden für organische Texturen zu erstellen.
...
Mit Splines kannst du die Richtung, die Trajektorie, die Intensität und die Thickness des Flows sowie die Verlaufsrampe steuern, mit der die gezeichneten Daten in den neutralen Hintergrund Verblassen werden.
...
|  |  |
|:---|:---|
| <b>Segmentierungsbetrag</b> <i>Ganzzahl</i> | Splines werden in Segmente vereinfacht, bevor sie von Vektor-Flussdaten durchlaufen werden. Eine größere Anzahl von Segmenten führt zu einer glatteren Flusszuordnung entlang von Kurven. |
| <b>Modus</b> <i>Ganzzahl</i> | Die Methode zum Auswählen der Splines, entlang denen Vektordatensätze gezeichnet werden sollen: <br><br>- <i>Spline-Liste zeichnen</i>: Alle Splines in der Eingabeliste werden verwendet;<br>- <i>Einzelne Spline zeichnen</i>: Nur der Spline mit dem angegebenen Index wird verwendet;<br>- <i>Spline-Bereich zeichnen</i>: Es werden nur die Splines verwendet, deren Index im angegebenen Bereich enthalten ist. |
...
| <b>Thickness-Modus</b> <i>Ganzzahl</i> | Die Methode zum Festlegen der Thickness der gezeichneten Vektordatenstromdaten <br><br>- <i>Manuell</i>: Legen Sie die Thickness explizit mit einem beliebigen Wert fest;<br>- <i>Von Spline</i>: Verwenden Sie die Thickness des Splines. |
...
| <b>Richtung</b> <i>Ganzzahl</i> | Die Richtung des Vektorflusses in Bezug auf den Spline.<br><br>- <i>Tangente</i>: Verwenden Sie den Spline-Tangente-Vektor;<br>- <i>Normal</i>: Verwenden Sie den normalen Vektor des Splines;<br>- <i>Normal gespiegelt</i>: Verwenden Sie die gespiegelte Version des normalen Vektors des Splines. |
