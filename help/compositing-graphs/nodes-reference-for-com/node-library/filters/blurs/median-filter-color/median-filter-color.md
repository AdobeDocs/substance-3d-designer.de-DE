...
| <b>Alpha betreffen</b> *Boolescher Wert* | Steuert, ob der Filter auf den Alphakanal des Bildes angewendet werden soll. Wenn *True*, bleibt der Alphakanal unverändert. |
