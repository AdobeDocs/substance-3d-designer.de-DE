...
Erzeugt einen Leuchteffekt um eine Eingabemaske (für die Graustufenversion) oder um eine Form mit einem Alphakanal (für die Farbversion). Im Vergleich zu [Glow](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/effects/glow/glow.md) funktioniert dies in einer Weise, die der anderer 2D-Bildbearbeitungssoftware ähnlicher ist, da es ein umfassenderer Effekt mit mehr Steuerelementen ist.
