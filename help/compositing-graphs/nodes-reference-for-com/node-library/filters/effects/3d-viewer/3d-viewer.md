---
title: 3D-Viewer
description: Designer > Substance von Compositing-Graphen > Knotenreferenz für Substance-Compositing-Graphen > Knotenbibliothek > Filter > Effekt > 3D-Viewer
...
Berechnet ein 3D-Rendering für eine angegebene SDF- oder Schnittpunktszene, die durch ein Funktionsdiagramm definiert ist, mit einer benutzerdefinierten Kamera und Umgebungslicht.<br><br>Dieser Knoten eignet sich zum Erstellen und Visualisieren von [SDF-Funktionen](../../../../../../function-graphs/nodes-reference-for-fun/function-node-library/function-node-library.md#sdf-functions), die im Knoten [Shape splatter v2](../../../texture-generators/patterns/shape-splatter-v2/shape-splatter-v2.md) verwendet werden sollen.<br><br>Es stehen Helper zur Verfügung, um Schlüsselattribute von Formen im Raum zu visualisieren.<br><br>Für fortgeschrittene Benutzer können benutzerdefinierte Funktionen erstellt werden, um die Kamera und/oder das 3D-Rendering pro Pixel einzurichten.
...
|                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|:---------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>Umgebung</b> *Farbe* | Das Bild, das auf die unendliche Kugel projiziert werden soll, wird als Umgebung der Szene verwendet und für die Umgebungsbeleuchtung verwendet.<br><br>Die Projektion ist <i>äquirektangulär</i>. Dasselbe wird von den Standardumgebungszuordnungen von Designer verwendet, die in der Kategorie <b>3D View > HDRI Environments</b> der Library verfügbar sind.<br><br>Wenn keine Verbindung besteht, wird eine Standardumgebung verwendet.<br><br><i>Tipp:</i> Verwenden Sie ein HDR-Bild (32-Bit) für eine präzise Beleuchtung. |
| <b>Eingabe 1</b> *Farbe* | Ein Bild, das im Funktionsdiagramm <b>Benutzerdefinierte Ausgabe</b> gesampelt werden kann, wenn der Parameter <b>Ausgabe</b> auf &quot;Benutzerdefiniert&quot; festgelegt ist.<br><br>Verwenden Sie einen Knoten [Beispielfarbe](../../../../../../function-graphs/nodes-reference-for-fun/atomic-function-nodes/sampler-nodes/sampler-nodes.md), der auf &quot;Bildeingabe 0&quot; festgelegt ist, um aus diesem Bild zu testen. |
| <b>Eingabe 2</b> *Farbe* | Ein Bild, das im Funktionsdiagramm <b>Benutzerdefinierte Ausgabe</b> gesampelt werden kann, wenn der Parameter <b>Ausgabe</b> auf &quot;Benutzerdefiniert&quot; festgelegt ist.<br><br>Verwenden Sie einen [Beispielfarbe](../../../../../../function-graphs/nodes-reference-for-fun/atomic-function-nodes/sampler-nodes/sampler-nodes.md)-Knoten, der auf &quot;Bildeingabe 1&quot; festgelegt ist, um aus diesem Bild zu scannen. |
...
|               |                                                                                                                                                                                                                                    |
|:--------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>Ausgabe</b> | Die gerenderte Szene verwendet den im Parameter <b>Ausgabe</b> ausgewählten AOV.<br><br><i>Hinweis:</i> Stellen Sie zum genauen Lesen in einigen AOVs sicher, dass die 2D-Ansicht einen linearen Farbraum verwendet und der Knoten ein HDR-32-Bit-Ausgabeformat verwendet. |
...
| <b>Hintergrundmodus</b> *Integer* | Gibt die Quelle des Hintergrunds der Szene an, die gezeichnet wird, wenn keine Formoberflächen sichtbar sind.<br><br>- <b>Farbe:</b> Die flache &quot;Hintergrundfarbe&quot;.<br>- <b>Umgebung:</b> Das Bild, das für den Eingang &quot;Umgebung&quot; bereitgestellt wird und auf eine unendliche Kugel mithilfe einer äquirektangulären Projektion angewendet wird.  (Wenn der Eingang nicht angeschlossen ist, wird eine Standardumgebung verwendet.) |
| <b>Hintergrundfarbe</b> *Float4* | Die als Hintergrund der Szene verwendete Flächenfarbe. |
| <b>IBL-Beispiele</b> *Integer* | Die Anzahl der pro Kameraprobe durchgeführten Lichtproben.<br><br>Ein höherer Wert führt zu einer glatteren, präziseren Beleuchtung auf Kosten der Leistung. |
| <b>Kamerabeispiele</b> *Integer* | Die Anzahl der pro Pixel durchgeführten Kameraproben.<br><br>Dieser Parameter beeinflusst die Qualität des Anti-Alias-Effekts und die Tiefe des Feldeffekts.<br><br>Ein höherer Wert führt zu einem deutlicheren, weniger lauten Bild auf Kosten der Leistung. |
...
| <b>Schritte zum Markieren sekundärer Strahlen</b> *Integer* | Die Anzahl der Schritte, die im Sphären-Tracing-Prozess ausgeführt werden, um die Diffusions- und Specular-Verdeckung zu berechnen, um geworfene Schatten zu zeichnen.<br><br>Ein höherer Wert führt zu präziseren Schatten auf Kosten der Leistung. |
