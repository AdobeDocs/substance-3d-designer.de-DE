...
>[!IMPORTANT]
>
> Alle Werte außerhalb des Bereichs [0,1] sind festgeklemmt, sodass das Histogramm für HDR-Bilder möglicherweise nicht genau ist.
...
|  |  |
| --- | --- |
| <b>Eingabe</b> *Graustufen* PRIMÄR | Das Bild, für das das Histogramm berechnet werden soll. |
