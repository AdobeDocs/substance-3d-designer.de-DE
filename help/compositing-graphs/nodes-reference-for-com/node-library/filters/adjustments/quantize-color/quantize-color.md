...
|  |  |
| --- | --- |
| <b>Eingabe</b> *Farbe* PRIMÄR | Das Farbbild, das quantisiert werden soll. |

## Ausgangsanschlüsse

|  |  |
| --- | --- |
| <b>Ausgabe</b> *Farbe* | Das quantisierte Farbbild. |
...
| <b>Konturglättung</b> *Gleitend* | Steuert den Radius eines Glättungseffekts, der auf das Eingabebild angewendet wird und verwendet wird, um das quantisierte Bild in einheitlichere Formen zu vereinfachen.   Hinweis: Diese Glättung erfordert intensive Berechnungen, sodass die Erhöhung dieses Wertes die Berechnungszeit des Knotens merklich erhöht. |
