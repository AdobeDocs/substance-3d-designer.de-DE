...
|  |  |
| --- | --- |
| <b>Normale Kombination</b> *Farbe* PRIMÄR | Die normale Karte, aus der Details entfernt werden sollen. |
| <b>Height</b> *Graustufen* | Die Height-Map, die die Oberflächendetails darstellt, die aus der kombinierten Normalmap entfernt werden sollen. |

## Ausgangsanschlüsse

|  |  |
| --- | --- |
| <b>Nicht kombinierte Normalwerte</b> *Farbe* | Die Normalmap, in der die Oberflächendetails, die durch die Eingabe-Height-Map beschrieben wurden, entfernt wurden. |
| <b>Empfohlene Intensität</b> *Gleitend* | Eine Schätzung der Intensität, die auf einen [Normal](../../../../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/normal/normal.md)-Knoten festgelegt werden sollte, der mit der Eingangs-Height-Map verbunden ist, um der Intensität der Eingangs-Normal-Map zu entsprechen. |
