...
<b> Textur: </b> definiert den *Pfad* der Bitmap, der als Pinsel-Textur verwendet werden soll. Sie können die Bitmap über den Dateibrowser Ihres Systems auswählen, indem Sie die Schaltfläche ![](../../../assets/2dview-paintingtools-brusheditor-selecttexture.png) neben dem Eingabefeld verwenden
...
Mit den Pinsel-, Stempel- und Radiergummi-Werkzeugen können Sie auch die ![](../../../assets/2dview-paintingtools-icon-tiling.png) <b>Kachelung-Modi</b> einstellen, die festlegen, dass *eine Schleifenwiedergabe um* erfolgen kann, wenn ein Strich auf einen Bereich außerhalb der Bildgrenzen wirkt:
...
![Kachelung-Modus](../../../assets/2dview-paintingtools-tiling.png "Kachelung-Modus")
