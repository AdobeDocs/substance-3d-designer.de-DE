...
![Bitmap-Malwerkzeuge in der 2D-Ansicht](../../../assets/2dview-paintingtools-main_1.png "Bitmap-Malwerkzeuge in der 2D-Ansicht"){width="512px"}
...
![Neues Bitmapdialogfeld](../../../assets/2dview-paintingtools-new-bitmap.png "Neues Bitmapdialogfeld"){width="512px"}
...
![](../../../assets/2dview-paintingtools-icon-colors-primary.png)![](../../../assets/2dview-paintingtools-icon-colors-secondary.png) <b>Farbauswahl</b> <b>Miniaturansichten:</b> Ermöglicht Ihnen das Definieren einer *primären* und *sekundären* Farbe. Klicken Sie auf eine dieser Miniaturansichten, um das Fenster &quot;<b>Color Editor</b>&quot; anzuzeigen und eine Farbe zu definieren. Tools verwenden die Farbe *primär*. Die primären und sekundären Farben können jederzeit *ausgetauscht* (<b>X</b>) werden.

![](../../../assets/2dview-paintingtools-icon-brush.png) <b>Pinselwerkzeug (B):</b> Wendet die *primäre* Farbe an der Cursorposition an, wenn die Stiftspitze oder die <b>LMB</b>-Schaltfläche gedrückt wird, wobei die in der Werkzeugoptionsleiste definierten Optionen verwendet werden
...
![](../../../assets/2dview-paintingtools-clone-alignment.png) <b>Ausrichtung aktivieren (Stempelwerkzeug-Option):</b> Hiermit können Sie definieren, ob die Quelle *an Ort und Stelle bleiben soll*, wenn ein neuer Stempel beginnt, oder ob *sie relativ zur neuen Stempelstelle verschieben soll*

<b>![](../../../assets/2dview-paintingtools-icon-eraser.png) Radiergummi (E):</b> Ersetzt die aktuelle Farbe des Bildes durch den Wert (0, 0, 0, 0) an der Cursorposition, wenn die Stiftspitze oder die Schaltfläche <b>LMB</b> gedrückt wird, und verwendet dabei die in der Werkzeugoptionsleiste definierten Optionen. Stellen Sie sicher, dass die [Transparenzanzeige](../../../interface/2d-view/2d-view.md) aktiviert ist, um die Auswirkungen dieses Tools auf den Kanal <b>Alpha</b> verfolgen zu können.
...
Mit der ![](../../../assets/2dview-paintingtools-brush-thumb.png) <b>Pinselauswahl</b> können Sie einen *vorkonfigurierten* Pinsel aus dem verfügbaren Pinsel *Vorgaben* auswählen, seine <b>Größe</b> und <b>Härte</b> *(* siehe Abschnitt <b>Form</b> des Pinseleditors) festlegen und eine *Vorschau* eines Pinselstrichs anzeigen.

Pinselvorgaben können im Pinseleditor erstellt und bearbeitet und in *Bibliotheken* angeordnet werden. Die Pinselvorgaben, die in diesem Bereich angezeigt werden, sind die *Summe* aller geladenen Pinselvoreinstellungsbibliotheken. Diese Bibliotheken können über das Menü ![](../../../assets/2dview-paintingtools-brushpresets-library.png) <b>Pinselbibliothek</b> verwaltet werden (siehe Abschnitt <b>Vorgaben</b> des Pinsel-Editors).

Mit der Schaltfläche ![](../../../assets/2dview-paintingtools-brushpresets-previewbkgd.png) <b>Hintergrundfarbe auswählen</b> können Sie die Hintergrundfarbe der *Pinselstrichvorschau* ändern.

</td>
<td style="border: 0;" valign="top">

![Pinselauswahlfenster](../../../assets/2dview-paintingtools-brushes.png "Pinselauswahlfenster")
...
Der ![](../../../assets/2dview-paintingtools-icon-brush-options.png) <b>Pinsel-Editor</b> bietet Zugriff auf granulare Optionen zum Definieren des Verhaltens des Pinsels:

<b>Vorgaben</b>

Pinsel können angepasst und dann als <b>Pinselvorgabe</b> gespeichert werden, die dann in der Liste ![](../../../assets/2dview-paintingtools-editor-currentpreset.png) <b>Pinselvorgaben</b> und im Bereich ![](../../../assets/2dview-paintingtools-brush-thumb.png) <b>Pinselauswahl</b> verfügbar ist.

Um eine Vorgabe zu erstellen, legen Sie die folgenden Eigenschaften nach Ihren Wünschen fest. Klicken Sie dann auf die Schaltfläche ![](../../../assets/2dview-paintingtools-editor-addpreset.png) <b>Pinselvorgabe hinzufügen </b> und legen Sie im Fenster <b>Vorgabenname</b> einen Pinselnamen fest. Die neue Vorgabe wird jetzt automatisch in der Liste <b>Pinselvorgaben</b> ausgewählt, und Sie können sie jederzeit ![](../../../assets/2dview-paintingtools-editor-updatepreset.png) <b>aktualisieren</b> mit den neuen aktuellen Einstellungen oder ![](../../../assets/2dview-paintingtools-editor-deletepreset.png) <b>löschen</b>.
...
![Pinsel-Editor](../../../assets/2dview-paintingtools-brusheditor.png "Pinsel-Editor")
...
+++Textur
Sie können eine *Bitmapdatei* auf den Pinsel anwenden und diese Bitmapdatei anstelle einer einfachen Farbe für *Stempel* verwenden. Die Pinselstruktur verhält sich wie folgt:

<b>Texturdatei: </b> definiert den *Pfad* der Bitmap, der als Pinselstruktur verwendet werden soll. Sie können die Bitmap über den Dateibrowser Ihres Systems auswählen, indem Sie die Schaltfläche ![](../../../assets/2dview-paintingtools-brusheditor-selecttexture.png) neben dem Eingabefeld verwenden
...
Die Farben der Textur sind *farblich verschoben* zur *festgelegten Primärfarbe*, was bedeutet, dass die Texturfarben unverändert verwendet werden können, wenn die festgelegte Primärfarbe Weiß ist. Je gesättigter die eingestellte Primärfarbe ist, desto stärker werden die Strukturfarben in Richtung auf sie hin verschoben
...
![Deckkraft- und Flusssteuerelemente](../../../assets/2dview-paintingtools-opacityflow.png "Deckkraft- und Flusssteuerelemente")
...
Mit den Pinsel-, Stempel- und Radiergummi-Werkzeugen können Sie auch ihre ![](../../../assets/2dview-paintingtools-icon-tiling.png) <b>Kachelmodi</b> einstellen, die ihre Fähigkeit definieren, *Schleifen um* auf die gegenüberliegende Seite des Bildes durchzuführen, wenn ein Strich einen Bereich außerhalb der Bildgrenzen betrifft:

<b>Kacheln von X und Y</b>: Pinselstrichkachel *sowohl horizontal als auch vertikal*

<b>Kacheln von X</b>: Pinselstrichkachel *nur horizontal*

<b>Anordnen von Y</b>: Pinselstrichkachel *nur vertikal*

<b>Keine Unterteilung</b>: Pinselstriche *nicht kacheln*

</td>
<td width="25.00%" style="border: 0;" valign="top">

![Kachelmodus](../../../assets/2dview-paintingtools-tiling.png "Kachelmodus")
