...
1. Klicken Sie auf die Schaltfläche ![](spot-colors-pantone.resources/spot-colors-pantone-01.png) <b>Farbwählertyp</b> neben dem RGB-Farbfeld.
1. Wählen Sie anstelle von <b>RGB von Farben</b> ein <b>Farbbuch</b> aus der Dropdown-Liste aus.
1. Das Symbol des ![](spot-colors-pantone.resources/spot-colors-pantone-02.png) <b>Farbwählertyps</b> ändert sich, und die Benutzeroberfläche ändert sich in den Modus <b>Volltonfarbe</b>.

![Wechseln in den Volltonfarbmodus](spot-colors-pantone.resources/spot-colors-pantone-03.gif "Wechseln in den Volltonfarbmodus"){width="512px"}
...
* Sie können die ![](spot-colors-pantone.resources/spot-colors-pantone-04.png) ![](spot-colors-pantone.resources/spot-colors-pantone-05.png) <b>Nach-links- und Nach-rechts-Pfeile</b> auf beiden Seiten der Buchseiten verwenden, um zwischen den Seiten zu wechseln. Sie können auch auf die Seitenanzeige klicken und sie ziehen, um zwischen den Seiten zu scrollen.
...
* Um eine größere, benutzerfreundlichere Oberfläche für das Farbbuch zu erhalten, klicken Sie auf das Farbvorschaufeld zwischen dem Symbol ![](spot-colors-pantone.resources/spot-colors-pantone-06.png) <b>Pipette</b> und dem ![](spot-colors-pantone.resources/spot-colors-pantone-04.png) <b>Linkspfeil</b>.

![Volltonfarben durchsuchen](spot-colors-pantone.resources/spot-colors-pantone-07.gif "Volltonfarben durchsuchen"){width="512px"}

### Volltonfarben aufnehmen und konvertieren

Volltonfarben können mit der ![](spot-colors-pantone.resources/spot-colors-pantone-06.png) <b>Pipette</b> ausgewählt werden. Im Volltonfarbmodus bedeutet dies, dass die aufgenommene RGB-Farbe in die Volltonfarbe umgewandelt wird, die der Volltonfarbe des aktuell ausgewählten Buchs am nächsten kommt.
...
![Auswählen und Konvertieren von Volltonfarben](spot-colors-pantone.resources/spot-colors-pantone-08.gif "Auswählen und Konvertieren von Volltonfarben"){width="512px"}
