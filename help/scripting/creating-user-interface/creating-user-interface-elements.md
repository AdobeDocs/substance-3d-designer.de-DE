---
helpx_url: "https://helpx.adobe.com/de/substance-3d-designer/scripting/creating-user-interface-elements.html"
breadcrumb-title: ''
description: Erfahren Sie, wie Sie Benutzeroberflächenelemente in Substance 3D Designer Python-Plug-ins für interaktive Benutzererlebnisse erstellen.
helpx_creative_field: ""
helpx_description: Designer > Scripting > Creating user interface elements
helpx_experience_level: ""
helpx_learn_topic: ""
helpx_tags: ""
title: Erstellen von Benutzeroberflächenelementen
...
Substance 3D Designer enthält <b>Qt für Python</b>. Benutzer können mit der [UI Manager](../../scripting/scripting-api-reference/scripting-api-reference.md)Klasse <b>Menüs</b>, <b>Dialogfelder</b>, <b>benutzerdefinierte Bedienfelder</b> und andere Benutzeroberflächenelemente für ihre Plug-ins erstellen.

Auf dieser Seite finden Sie einfache Beispiele für die Verwendung von Qt für Python in Designer.

Weitere Informationen zu Qt für Python finden Sie in der offiziellen [Dokumentation.](https://doc.qt.io/qtforpython/index.html)
...
### Erstellen von Symbolleisten im Anwendungsfenster
...
### Erstellen von Symbolleisten in der Diagrammansicht
...
### Erstellen von Aktionen in der Symbolleiste &quot;Diagrammansicht&quot;
...
### Laden von Benutzeroberflächen, die mit Qt Designer erstellt wurden

>[!NOTE]
>
> Qt Designer ist *nicht in Substance 3D Designer enthalten*. Sie können es erhalten, indem Sie die offizielle Qt-Distribution für Ihr Betriebssystem installieren.
