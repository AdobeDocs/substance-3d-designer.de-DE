...
Die Schaltfläche <b>Aktualisieren</b> kann zum *Aktualisieren* der Plug-in-Liste verwendet werden. Dies ist nützlich, wenn Plug-ins mit der Python-API geladen werden.

>[!NOTE]
>
> Wenn das Plug-In ein *Modul* (d. h. ein Verzeichnis) ist, kann es geladen werden, indem Sie die Datei <b>\_\_init\_\_.py</b> innerhalb des Moduls auswählen.
